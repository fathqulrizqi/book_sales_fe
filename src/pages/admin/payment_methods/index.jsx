...
import { getPaymentMethods } from "../../../services/payment_methods";
...
export default function PaymentMethods() {
  ...
  return (
    ...
    >
      ...
      <h1 className="sm:text-3xl text-2xl font-medium title-font text-indigo-900 mb-4 px-4">Payment Methods</h1>
        <table className="w-full table-auto">
          ...
          <tbody key={index}>
            <tr className="hover:bg-gray-50">
              ...
              <td className="px-4 py-5">
                <p className="text-black :text-white">{payment_method.image}</p>
              </td>
              <td className="px-4 py-5">
